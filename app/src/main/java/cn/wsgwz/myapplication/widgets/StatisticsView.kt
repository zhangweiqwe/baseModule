...
//两个坐标形成变量，规定了渐变的方向和间距大小，着色器为镜像
        val linearGradient = LinearGradient(0f, 0f, 0f, DensityUtil.dp2px(120f), Color.RED, Color.RED, Shader.TileMode.CLAMP)
        paint.isAntiAlias = true
        paint.shader = linearGradient
        paint.style = Paint.Style.FILL_AND_STROKE
        paint.strokeWidth = DensityUtil.dp2px(2f)
        ...
        canvas.drawRoundRect(RectF(DensityUtil.dp2px(30f), 0f,  DensityUtil.dp2px(130f),  DensityUtil.dp2px(180f)), 20f, 20f, paint)

...
abstract class BaseProgressFrameLayout @JvmOverloads constructor(
        ...
        when (currentState) {
            ...
            STATE_LOADING -> {
                ...
                if (loadingState == null) {
                    ...
                    addView(loadingState, LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT).apply {
            ...
            STATE_ERROR -> {
                ...
                if (errorState == null) {
                    ...
                    addView(errorState, LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT).apply {
                        gravity = Gravity.CENTER
                    })
